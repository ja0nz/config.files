...
link_target_prefix = "file:///usr/share/doc/racket/local-redirect/";

var user_link_dirs = [
 ["markdown", "file:///home/jan/.racket/7.4/pkgs/markdown/markdown/doc/markdown"],
 ["parsack", "file:///home/jan/.racket/7.4/pkgs/parsack/parsack/doc/parsack"],
 ["pollen", "file:///home/jan/.racket/7.4/pkgs/pollen/pollen/doc/pollen"],
 ["rackjure", "file:///home/jan/.racket/7.4/pkgs/rackjure/rackjure/doc/rackjure"],
 ["sexp-diff", "file:///home/jan/.racket/7.4/pkgs/sexp-diff/sexp-diff/doc/sexp-diff"],
 ["sugar", "file:///home/jan/.racket/7.4/pkgs/sugar/sugar/doc/sugar"],
 ["threading", "file:///home/jan/.racket/7.4/pkgs/threading-doc/scribblings/doc/threading"],
 ["txexpr", "file:///home/jan/.racket/7.4/pkgs/txexpr/txexpr/doc/txexpr"]];
   ...
   for (var i = 0; i < elements.length; i++) {
     ...
     if (tag) {
       ...
       if (!user_loaded_link_targets[v]) {
         ...
         var p = "file:///home/jan/.racket/7.4/doc/local-redirect_" + v + ".js";
         if (user_link_target_prefix) {
           p = user_link_target_prefix + p;
         }
         demand_load(p, false);
